...
The public API lives at the module root (`github.com/go-ruby-jbuilder/jbuilder`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `jbuilder`, while the surface follows
...
```go
import "github.com/go-ruby-jbuilder/jbuilder"
```
...
- **[pkg.go.dev/github.com/go-ruby-jbuilder/jbuilder](https://pkg.go.dev/github.com/go-ruby-jbuilder/jbuilder)**

The module's [README](https://github.com/go-ruby-jbuilder/jbuilder#readme) carries worked
