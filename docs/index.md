# go-ruby-jbuilder documentation

**Pure-Go, MRI-faithful Ruby jbuilder (no cgo)**

`go-ruby-jbuilder/jbuilder` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `jbuilder`,
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `jbuilder`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`jbuilder`](https://github.com/go-ruby-jbuilder/jbuilder) | the library — Ruby's `jbuilder` in pure Go |
| [`docs`](https://github.com/go-ruby-jbuilder/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-jbuilder.github.io`](https://github.com/go-ruby-jbuilder/go-ruby-jbuilder.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-jbuilder/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-jbuilder/jbuilder](https://github.com/go-ruby-jbuilder/jbuilder).
