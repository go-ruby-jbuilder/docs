...
Contributions are welcome. `go-ruby-jbuilder/jbuilder` is built to a small set of
...
The library is in [`github.com/go-ruby-jbuilder/jbuilder`](https://github.com/go-ruby-jbuilder/jbuilder).
This documentation site is in [`github.com/go-ruby-jbuilder/docs`](https://github.com/go-ruby-jbuilder/docs).
