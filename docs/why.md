...
`go-ruby-jbuilder/jbuilder` reimplements Ruby's `jbuilder` in **pure Go, with cgo disabled**. The slice of
...
- any Go program can import `github.com/go-ruby-jbuilder/jbuilder` directly, with no Ruby runtime;
